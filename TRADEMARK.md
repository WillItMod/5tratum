...
## Official domains
Official project sites and stores may be hosted under (including regional TLDs):
...
- Distributing modified builds using the `5tratum` or `5tratumOS` name, logo, or confusingly similar branding.
- Selling, bundling, or pre-installing the software while representing it as official `5tratum` / `5tratumOS`.
- Using `5tratum` / `5tratumOS` branding in a way that implies endorsement, partnership, or certification.
...
Do not use them to market forks/derivatives without permission.

## Contact
For branding permissions, contact the maintainer(s) via the official repository issues or an email address listed there.
